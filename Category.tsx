        ...
        selectedCollection == "collections" ? (
            ...
            imageScreen == "None" ? (
                ...
                <View style={styles.background}>
                    ...
                    <ImageZoom cropWidth={phonewidth * framescale} cropHeight={phoneheight * framescale} imageHeight={phoneheight * framescale} imageWidth={imageWidth * ((framescale * phoneheight) / imageHeight)} style={{ backgroundColor: "black", alignSelf: "center" }} enableCenterFocus={false} pinchToZoom={false} onMove={(element) => { setImagePos(element) }} centerOn={{ x: 0, y: 0, scale: 1, duration: 10}}>
