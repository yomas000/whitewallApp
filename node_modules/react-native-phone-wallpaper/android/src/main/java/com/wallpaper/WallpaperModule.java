...
public class WallpaperModule extends ReactContextBaseJavaModule {
  ...
  @ReactMethod
  public void setWallpaper(String imageUrl, String flag, String left, String top, String right, String bottom, Promise promise) {
    new SetWallpaperTask(promise).execute(imageUrl, flag, left, top, right, bottom);
  }
  ...
  private class SetWallpaperTask extends AsyncTask<String, Void, Boolean> {
    ...
    protected Boolean doInBackground(String... params) {
      ...
      int right = Integer.parseInt(params[4]);
      int bottom = Integer.parseInt(params[5]);
      ...
      try {
        ...
        wallpaperManager.setBitmap(bitmap, rect, false, flag);
        return true;
      } catch (IOException e) {
        e.printStackTrace();
        return false;
